...
const fieldClass =
  "type-regular h-12 rounded-[5px] border border-[#273c5b]/24 bg-white/85 px-4 text-[#152435] outline-none transition placeholder:text-[#273c5b]/45 focus:border-[#169bd5] focus:ring-4 focus:ring-[#169bd5]/15";

const selectFieldClass =
  "form-select-field type-regular h-12 rounded-[5px] border border-[#273c5b]/24 bg-white/85 pl-4 pr-14 text-[#152435] outline-none transition focus:border-[#169bd5] focus:ring-4 focus:ring-[#169bd5]/15";
    ...
    <main className="min-h-screen overflow-x-clip bg-[#eef6fc] text-[#273c5b]">
      ...
      <section className="mx-auto grid w-[min(calc(100dvw-2rem),86rem)] gap-8 px-4 pb-16 min-[1120px]:px-1 lg:grid-cols-[1fr_0.42fr] lg:pb-20">
        <form
          ...
          className="rounded-[5px] border border-white/80 bg-[linear-gradient(145deg,#fcfdfc_0%,#e9f0f6_100%)] p-6 shadow-[0_18px_36px_rgba(21,36,53,0.08)] sm:p-8"
        >
          <div>
            <p className="type-eyebrow uppercase text-[#273c5b]">
              Service request
            ...
            {hasSubmissionError ? (
              <p className="type-small mt-4 rounded-[5px] border border-[#cc0d0d]/30 bg-[#cc0d0d]/10 px-4 py-3 font-semibold text-[#cc0d0d]">
          ...
          <button
            className="hero-primary-cta mt-8 inline-flex h-12 w-full items-center justify-center whitespace-nowrap rounded-[5px] bg-[#cc0d0d] px-6 text-base font-extrabold uppercase tracking-[0.04em] text-white shadow-[0_12px_24px_rgba(21,36,53,0.12)] transition hover:bg-[#e11212] sm:w-auto"
            type="submit"
          >
        ...
        <div className="grid gap-5 self-start">
          <aside className="rounded-[5px] bg-[#273c5b] p-6 text-white shadow-[0_18px_36px_rgba(21,36,53,0.16)] sm:p-8">
          ...
          <aside className="rounded-[5px] border border-white/80 bg-[linear-gradient(145deg,#fcfdfc_0%,#e9f0f6_100%)] p-6 shadow-[0_18px_36px_rgba(21,36,53,0.08)] sm:p-8">
            <p className="type-eyebrow uppercase text-[#273c5b]">
              What we review
            </p>
