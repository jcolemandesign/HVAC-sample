      ...
      {reasons.map((reason, index) => (
        ...
        >
          <div className="w-full max-w-[35rem] text-left">
            <h3 className="font-expanded text-2xl font-medium text-[#273c5b]">
              {reason.title}
            </h3>
            <p className="font-expanded mt-6 text-[clamp(1.35rem,1.5vw,2rem)] font-extralight leading-[1.22] text-[#273c5b]">
              {reason.description}
            </p>
          </div>
        </article>
