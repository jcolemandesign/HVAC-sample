...
export function PasswordResetRequest() {
  ...
  return (
    <form className="mt-8 border-t border-[#273c5b]/12 pt-7" onSubmit={handleSubmit}>
      ...
      <button
        className="mt-5 inline-flex h-11 w-full items-center justify-center rounded-[6px] border border-[#273c5b]/24 px-5 text-sm font-semibold uppercase tracking-[0.04em] text-[#273c5b] transition hover:border-[#273c5b] hover:bg-white/55 disabled:cursor-wait disabled:opacity-70"
